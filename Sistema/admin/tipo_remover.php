...
<div class="col-lg-12">
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            <p>O tipo foi removido com sucesso!<br/><a href="<?php echo TGlobal::$default_url_path; ?>/admin/tipos">>>Ir para tipos<<</a></p>
        </div>
                ...
                <form method="POST" action="#">
                	...
                	<div class="col-lg-12">
                    	<div class="form-group">
                            ...
                            <input class="form-control" type="text" readonly="readonly" name="referencia" value="<?php echo $referencia; ?>" />
                        </div>
                    </div>    
                    <div class="col-lg-4">
                    	<div class="form-group">       
                            <label style="color: #fff;">.</label>                    
                            <input type="submit"class="form-control btn btn-danger btn-block" value="Remover Tipo"/>
                        </div>
                    </div>
                </form>
            </div>
